...
export default defineComponent({
  ...
  methods: {
    loadQuestions: function() {
      axios
        .get('/api/questions?topic=' + this.topicId + "&requirement=" + this.requirementId + "&exam=" + this.examId + "&search=" + this.search)
        .then((response) => {
